...
def run_feature_selection(num_features):
    ...
    enet_features = [36,3,37,4,39,6,51,48,42,45,18,15,12,9,40,7,60,54,27,58,53,50,44,21,20,17,11,41,8,65,32,14,47,52,49,43,25,19,16,13,10,46,26,59,61,28,64,31,57,24,34,33,0,63,62,56,55,38,35,30,29,23,22,5,2,1]
    consensus_features = enet_features[:num_features]
    ...
    npz_filename = 'enet_classificationscores' + database.split('.')[0] + 'svmminmax' + str(num_features) + 'features.npz'
    ...
    results_filename = 'enet_results'+database.split('.')[0]+'svmminmax'+str(num_features)+'features.txt'
    ...
    roc_filename = 'enet_roc'+database.split('.')[0]+'svmminmax'+str(num_features)+'features.png'
    rocch_filename = 'enet_rocch'+database.split('.')[0]+'svmminmax'+str(num_features)+'features.png'
    pr_filename = 'enet_pr'+database.split('.')[0]+'svmminmax'+str(num_features)+'features.png'
    det_filename = 'enet_det'+database.split('.')[0]+'svmminmax'+str(num_features)+'features.png'
    detch_filename = 'enet_detch'+database.split('.')[0]+'svmminmax'+str(num_features)+'features.png'
    score_filename = 'enet_score'+database.split('.')[0]+'svmminmax'+str(num_features)+'features.png'
    # plot the roc curve
